...
<h1>Exchange rate is: 1 MyTok for 0.000000000000000001 ETH</h1>
...
<br /><br />
    ...
    <button type="button" onClick={this.handleBuyToken}>Or buy 1 MyTok</button>
<br /><br />

 <p>You currently have {this.state.userTokens} MyTok</p>
